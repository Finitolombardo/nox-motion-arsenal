...
const AUTHORED_PRESETS: Record<string, AuthoredPreset[]> = {
  'bg-nox-interactive-glyph-field': [
    ...
    { niche: 'automotive', why: 'Circuit glyphs at charged state read as engineered precision behind a vehicle hero.', props: { mode: 'glyphs', variant: 'automation-circuit-glyphs', stateMode: 'charged', interaction: 'pointer-proximity', glyphCount: 16, intensity: 0.72, proximityRadius: 200, parallax: 0.4 }, performanceProfile: 'balanced' },
  ],
