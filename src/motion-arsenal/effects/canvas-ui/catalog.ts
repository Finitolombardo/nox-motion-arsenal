...
export const CANVAS_UI_CATALOG: EffectEntry[] = [
  ...
  },
  {
    meta: {
      ...
      sourceFiles: ['ParticleFieldSystem.tsx', 'ParticleObject.tsx', 'ParticleReveal.tsx'], mode: 'nox-adapted', complexity: 'high', dependencies: [], legacyIds: ['canvasui-particle-object', 'canvasui-particle-reveal'], supersedes: ['ParticleObject', 'ParticleReveal'], deprecationNotes: 'Saved legacy IDs resolve to this core; direct standalone imports remain supported.',
