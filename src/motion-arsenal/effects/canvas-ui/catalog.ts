...
export const CANVAS_UI_CATALOG: EffectEntry[] = [
  ...
  },
  {
    meta: {
      ...
      sourceFiles: ['ParticleFieldSystem.tsx', 'ParticleObject.tsx', 'ParticleReveal.tsx'], mode: 'nox-adapted', complexity: 'high', dependencies: [], supersedes: ['ParticleObject', 'ParticleReveal'], deprecationNotes: 'Direct standalone component imports remain supported.',
