...
export const CANVAS_UI_CATALOG: EffectEntry[] = [
  ...
  {
    meta: {
      id: 'canvasui-particle-field-system', name: 'ParticleFieldSystem', category: 'canvas-ui', sourceWebsite: 'nox-consolidated',
      sourceFiles: ['ParticleFieldSystem.tsx', 'ParticleObject.tsx', 'ParticleReveal.tsx'], mode: 'nox-adapted', complexity: 'high', dependencies: [], legacyIds: ['canvasui-particle-object', 'canvasui-particle-reveal'], supersedes: ['ParticleObject', 'ParticleReveal'], deprecationNotes: 'Legacy static IDs resolve to this core; direct component imports remain supported.',
      bestFor: ['Asset particle fields', 'Text particle reveals'], performanceNotes: 'One Canvas2D scene with bounded 300–4200 particle density; sampling happens only when inputs change.', mobileNotes: 'A deterministic drift replaces pointer-only interaction.', reducedMotionNotes: 'Settles the source cloud without simulation.',
      description: 'Source-ready particle-field core that keeps asset reconstruction and text reveal as explicit standalone modes.', importPath: '@/motion-arsenal/effects/canvas-ui/ParticleFieldSystem', usageJsx: '<ParticleFieldSystem mode="reveal" text="NOX SIGNAL" density={2200} />',
      props: [{ key: 'preset', label: 'Preset', type: 'select', default: 'saas', options: ['restaurant', 'beauty', 'fitness', 'local-service', 'real-estate', 'automotive', 'healthcare', 'finance', 'saas', 'ecommerce', 'luxury', 'creator'] }, { key: 'mode', label: 'Mode', type: 'select', default: 'asset', options: ['asset', 'reveal'] }, { key: 'text', label: 'Text', type: 'text', default: 'NOX SIGNAL' }, { key: 'density', label: 'Density', type: 'range', default: 3000, min: 300, max: 4200, step: 100 }, { key: 'particleSize', label: 'Particle Size', type: 'range', default: 1.8, min: 0.5, max: 4, step: 0.05 }, { key: 'color', label: 'Color', type: 'color', default: '#C93030' }, { key: 'interactionStrength', label: 'Interaction', type: 'range', default: 1, min: 0, max: 2, step: 0.05, group: 'Advanced' }, { key: 'scatter', label: 'Scatter', type: 'range', default: 11, min: 0, max: 24, step: 0.5, group: 'Advanced' }], productionSafe: true, status: 'production-safe', clickToRun: true, fullBleed: true,
    }, Component: lazy(() => import('./ParticleFieldSystem')),
  },
];
