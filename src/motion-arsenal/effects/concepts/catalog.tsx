...
export const CONCEPTS_CATALOG: EffectEntry[] = entries.map(([name, description, technicalBasis], tone) => ({
  meta: {
    ...
    dependencies: [],
    bestFor: ['Konzeptbewertung und spätere Implementierung'],
    performanceNotes: 'Konzept-Preview: Produktions-Performance noch nicht validiert.',
    ...
    usageJsx: `{/* Konzept: ${name} zuerst implementieren und prüfen. */}`,
    props: [],
  ...
  Component: () => <ConceptEffectPreview name={name} tone={tone} />,
}));
