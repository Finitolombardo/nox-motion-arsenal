...
export interface FormSignalSystemProps {
  accent?: string;
...
/** Canonical form signal-feedback core; legacy validation components delegate here. */
export function FormSignalSystem({
...
export default FormSignalSystem;