import{R as j,r as l,j as X}from"./index-CfWFdp0n.js";const pe="https://imagedelivery.net/IEUjvl3YUlxY-MrTpOAWDQ/3fb4a247-64e9-4c54-2391-86598eebfe00/w=800",ie=2,Te=20,ve=32,xe=1e3;let le=xe;function Re(){return le+=1,le}const Ee=3,Se=.05,Ae=.05,Me=.035,be=1.92,_e=.15,Le=.88,ye=`
attribute vec2 aPos;
attribute vec2 aUV;
uniform float uPeel;
uniform float uLift;
